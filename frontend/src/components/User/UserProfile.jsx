...
export default function UserProfile() {
    ...
    return <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div
                className="bg-white bg-opacity-80 rounded-md shadow-custom overflow-hidden card-hover animate-fade-in">
                <div className="p-6">
                    <div className="flex items-center mb-4">
                        ...
                        <h2 className="text-xl font-semibold text-orange-500">Edit Contact</h2>
                    </div>
                    <form onSubmit={isHasContact ? handleUpdateContact : handleCreateContact}>
                        <div className="mb-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="first_name" className="block text-orange-600 text-sm font-medium mb-2">First Name</label>
                            ...
                            <div>
                                <label htmlFor="last_name" className="block text-orange-600 text-sm font-medium mb-2">Last Name</label>
                        ...
                        <div className="mb-5">
                            <label htmlFor="email" className="block text-orange-600 text-sm font-medium mb-2">Email</label>
                        ...
                        <div className="mb-5">
                            <label htmlFor="phone" className="block text-orange-600 text-sm font-medium mb-2">Phone Number</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div className="mt-6">
                            <button type="submit"
                                    className="w-full bg-orange-500 text-white py-3 px-4 rounded-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-orange-800 transition-all duration-200 font-medium shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center">
            ...
            <div
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmitPassword}>
                        <div className="mb-5">
                            <label htmlFor="new_password" className="block text-orange-600 text-sm font-medium mb-2">New
                                Password</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <input type="password" id="new_password" name="new_password"
                                    className="w-full pl-10 pr-3 py-3 bg-orange-100 bg-opacity-50 border border-orange-300 text-orange-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200"
                        ...
                        <div className="mb-5">
                            <label htmlFor="confirm_password" className="block text-orange-600 text-sm font-medium mb-2">Confirm New
                                Password</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
